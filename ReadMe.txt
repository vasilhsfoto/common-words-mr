...
Based on how M/R works, this means that all the same words (based on equals) will be processed 
by the same reducer. In a nutshell, a hash function executed against the word (type of Text) 
...
and it is writen to the output.
